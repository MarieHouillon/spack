...
class PyTables(PythonPackage):
    ...
    # setup.py
    depends_on("python@3.9:3.12", when="@3.9.0:", type=("build", "run"))  
    depends_on("python@3.8:3.11", when="@3.8.0", type=("build", "run"))  
    depends_on("python@3.6:3.10", when="@3.7.0", type=("build", "run"))  
    depends_on("python@3.6:3.9", when="@3.6.0:3.6.1", type=("build", "run"))  
    depends_on("python@3.4:3.7", when="@3.4.4:3.5.2", type=("build", "run"))  
    depends_on("python@3.4:3.6", when="@:3.4.3", type=("build", "run"))  
